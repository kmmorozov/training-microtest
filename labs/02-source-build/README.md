...
**Зачем: Получаем инструменты сборки и архив из указанного источника, чтобы исключить неизвестные зависимости и проверить целостность исходников.**
...
**Зачем: Собираем и проверяем iperf3 до установки, затем подтверждаем загрузку библиотек и локальный обмен клиент–сервер.**
